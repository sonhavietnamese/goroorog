...
const Control = forwardRef<ControlApi, ControlProps>(
  (
    {
      children,
      debug = false,
    ...
    return (
      <Suspense fallback={null}>
        <group {...props} ref={characterGroupRef} dispose={null}>
          ...
          {/* Character model */}
          <group name='Control-Model' ref={characterModelRef}>
            {children}
          </group>
        </group>
...
export interface ControlProps extends Omit<React.ComponentProps<'group'>, 'ref'> {
  children?: ReactNode
  debug?: boolean
